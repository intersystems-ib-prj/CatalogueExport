...
CREATE GLOBAL TEMPORARY TABLE temp.rawData_406(subject_id INT,gender_concept_id INT,count_value NUMERIC);
...
CREATE GLOBAL TEMPORARY TABLE temp.tempResults_406(analysis_id INT,stratum1_id INT,stratum2_id INT,count_value NUMERIC,min_value NUMERIC,max_value NUMERIC,avg_value NUMERIC,stdev_value NUMERIC,median_value NUMERIC,p10_value NUMERIC,p25_value NUMERIC,p75_value NUMERIC,p90_value NUMERIC);
